...
public class Nav_path : MonoBehaviour
{
    ...
    public Vector3 Destination
    {
        ...
        set
        {
            ...
            Nav_node startNode = Nav_node.GetNearestNavNode(agent.transform.position);
            Nav_node endNode = Nav_node.GetNearestNavNode(value);
            ...
            Nav_Dijkstra.Generate(startNode, endNode, ref path);
    ...
    public Nav_node GetNextNavNode(Nav_node node)
    {
